...
$usage = <<EOF;
	...
	-r	Approximate RAM memory to use in GB. Value should be >=5. The more the RAM, the fast the software will run. Based on tests on different datasets, maximum RAM value used by this script did not exceeded 165 (default: 5).
