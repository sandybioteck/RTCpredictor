...
<br>The output of the above script will be 2 database files named 'database.tsv' and 'exons.tsv' which needs to be given as input file to run 'RTCpredictor.pl' script for predicting read-through chimeric RNAs for the genome of interest.
